...
public class WScratchView extends SurfaceView implements IWScratchView, SurfaceHolder.Callback {
    ...
    public void setScratchBitmap(Bitmap b) {
        ...
        Log.d("salimmm", "setScratchBitmap width ===" + mScratchBitmap.getWidth());
        Log.d("salimmm", "setScratchBitmap height ===" + mScratchBitmap.getHeight());
    }
    ...
    // Add a file name generator for saved images
